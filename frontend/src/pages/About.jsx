export default function About(){
  return ( 
    <>
      ...
      Whether you’re grabbing a quick bite, sharing a meal with friends, or just chasing 
      that late-night craving, we’ve got something to hit the spot. Great food, good vibes, and 
      plenty of chopsticks to go around!
      </p>
    </>
  )
}